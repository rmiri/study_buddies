...
StudyGroup.create(user:User.first,location: Location.first, subject: Subject.first, date:"2021-01-30 09:00",time:"2020-01-30 09:00",duration:1,num_participants:Location.first.capacity,name:"Code Review",description:"nascetur ridiculus mus mauris vitae ultricies leo integer malesuada nunc")
StudyGroup.create(user:User.second,location: Location.first, subject: Subject.second, date:"2021-01-25 10:00",time:"2020-01-25 10:00",duration:2,num_participants:Location.first.capacity,name:"Survive Guide",description:"mauris in aliquam sem fringilla ut morbi tincidunt augue interdum velit euismod in pellentesque massa placerat duis ultricies lacus")
StudyGroup.create(user:User.third,location: Location.third, subject: Subject.third, date:"2021-01-26 11:00",time:"2020-01-26 11:00",duration:1,num_participants:Location.third.capacity,name:"Next Class Prep",description:"dui faucibus in ornare quam viverra orci sagittis eu volutpat odio facilisis mauris sit amet massa vitae tortor condimentumk")
StudyGroup.create(user:User.fourth,location: Location.fifth, subject: Subject.first, date:"2021-01-26 12:00",time:"2020-01-26 12:00",duration:1,num_participants:Location.fifth.capacity,name:"Coding for dummies",description:"cursus sit amet dictum sit amet justo donec enim diam")
StudyGroup.create(user:User.fifth,location: Location.first, subject: Subject.first, date:"2021-01-28 15:00",time:"2020-01-28 15:00",duration:1,num_participants:Location.first.capacity,name:"Dealing with users",description:"leo integer malesuada nunc vel risus commodo viverra maecenas accumsan")
StudyGroup.create(user:User.first,location: Location.second, subject: Subject.first, date:"2021-01-29 18:00",time:"2020-01-29 18:00",duration:1,num_participants:Location.second.capacity,name:"Code Review 2 - the return",description:"fringilla phasellus faucibus scelerisque eleifend donec pretium vulputate sapien nec")