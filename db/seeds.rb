...
User.create(name:"Mariola", email:"paskomariola@gmail.com", password_digest:"p1")
User.create(name:"Renata", email:"renata@gmail.com", password_digest:"p1")
User.create(name:"Gabi", email:"gabi@gmail.com", password_digest:"p1")
User.create(name:"Anna", email:"anna@gmail.com", password_digest:"p1")
User.create(name:"Sofia", email:"sofia@gmail.com", password_digest:"p1")
User.create(name:"Marcus", email:"marcus@gmail.com", password_digest:"p1")
User.create(name:"Carlo", email:"carlo@gmail.com", password_digest:"p1")
User.create(name:"John", email:"john@gmail.com", password_digest:"p1")

User.create(name:"Mariola", email:"paskomariola2@gmail.com", password_digest:"p1")
User.create(name:"Renata", email:"renata2@gmail.com", password_digest:"p1")
User.create(name:"Gabi", email:"gabi2@gmail.com", password_digest:"p1")
User.create(name:"Anna", email:"anna2@gmail.com", password_digest:"p1")
User.create(name:"Sofia", email:"sofia2@gmail.com", password_digest:"p1")
User.create(name:"Marcus", email:"marcus2@gmail.com", password_digest:"p1")
User.create(name:"Carlo", email:"carlo2@gmail.com", password_digest:"p1")
User.create(name:"John", email:"john2@gmail.com", password_digest:"p1")
